        ...
        <div className='md:col-span-2 '>
          <div className='flex items-center gap-5'>
            ...
            <div>
              ...
              <h3 className='text-headingColor text-[22px] leading=9 mt-3 font-bold'>Dr. Manish Gupta</h3>
              <div className='flex items-center gap-[6px] '>
                <span className='flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading=7 font-semibold text-headingColor'>
                  <img src={starIcon} alt='' />4.5
                </span>
                <span className='bg-[#ccF0F] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>
               {272}
              </span>
              </div>
